define([
  ...
  var planetView = backbone.View.extend({
    ...
    /*projection: function() {
      ...
      var svg = d3.select("#planet_surface_area").selectAll("svg").data(this.model.get('data')).enter().append("svg")
          .attr("width", function(d){
            return 500;//d.diameter/100;
          })
          .attr("height", function(d){
            return 500;//d.diameter/100;
          })
          //.attr("viewBox",function(d) {
            //return "150 0 "+d.diameter/100+" "+d.diameter/100;
          //})
      console.log(d3.select("#planet_surface_area svg").datum());

      var projection = d3.geo.august()
          .scale(50)//svg.datum().diameter/20000)
